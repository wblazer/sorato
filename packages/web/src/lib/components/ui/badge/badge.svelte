  ...
  export const badgeVariants = tv({
    ...
    variants: {
      variant: {
        ...
        destructive:
          'bg-danger-muted [a]:hover:bg-danger-muted-hover focus-visible:ring-danger/30 text-danger-muted-foreground',
        outline:
          'border-border text-foreground [a]:hover:bg-base-hover [a]:hover:text-muted-foreground bg-surface',
