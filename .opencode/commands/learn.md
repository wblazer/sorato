...
When the user invokes `/learn`, help them update the AGENTS.md nodes with learnings from the current session.

## Your Task

1. **Analyze the session**: Review what files were changed, what was built, what problems were solved
2. **Identify relevant AGENTS.md nodes**: Determine which node(s) should capture these learnings
...
5. For significant changes: explain what you want to add and ask "Should I add this to AGENTS.md?"
...
**Automatic**: "I'll add a link to `src/db/AGENTS.md` in the root Map Navigation section."

**Ask**: "I noticed you established a pattern of always using transactions for multi-table operations. Should I document this as a best practice in `src/db/AGENTS.md`?"
